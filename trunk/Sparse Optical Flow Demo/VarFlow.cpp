...
*/
VarFlow::VarFlow(double width_in, double height_in, int max_level_in, int start_level_in, int n1_in, int n2_in,
	...
	int width = (int)floor(width_in/pow(2.0f,(float)(start_level)));
    int height = (int)floor(height_in/pow(2.0f,(float)(start_level)));
    ...
    if(width < 1 || height < 1)
    {
        if(width < 1)
        {
              start_level = (int)floor(log(width_in)/log(2.0));
              width = (int)floor(width_in/pow(2.0f,(float)(start_level)));
              height = (int)floor(height_in/pow(2.0f,(float)(start_level)));
        }
        
        if(height < 1)
        {
              start_level = (int)floor(log(height_in)/log(2.0));
              width = (int)floor(width_in/pow(2.0f,(float)(start_level)));
              height = (int)floor(height_in/pow(2.0f,(float)(start_level)));
        }
    ...
    int width_end = (int)floor(width_in/pow(2.0f,(float)(max_level)));
    int height_end = (int)floor(height_in/pow(2.0f,(float)(max_level)));
    ...
    if(width_end < 1 || height_end < 1)
    {
        if(width_end < 1)
        {
              max_level = (int)floor(log(width_in)/log(2.0));
              height_end = (int)floor(height_in/pow(2.0f,(float)(max_level)));
        }
        
        if(height_end < 1)
        {
              max_level = (int)floor(log(height_in)/log(2.0));
        }
    ...
    for(i = 0; i < (max_level-start_level+1); i++){
        ...
        imgAfxfx_array[i] = cvCreateImage(cvSize((int)floor(width/pow(2.0f,(float)(i))),(int)floor(height/pow(2.0f,(float)(i)))), IPL_DEPTH_32F, 1);
        imgAfxfy_array[i] = cvCreateImage(cvSize((int)floor(width/pow(2.0f,(float)(i))),(int)floor(height/pow(2.0f,(float)(i)))), IPL_DEPTH_32F, 1);
        imgAfxft_array[i] = cvCreateImage(cvSize((int)floor(width/pow(2.0f,(float)(i))),(int)floor(height/pow(2.0f,(float)(i)))), IPL_DEPTH_32F, 1);
        imgAfyfy_array[i] = cvCreateImage(cvSize((int)floor(width/pow(2.0f,(float)(i))),(int)floor(height/pow(2.0f,(float)(i)))), IPL_DEPTH_32F, 1);
        imgAfyft_array[i] = cvCreateImage(cvSize((int)floor(width/pow(2.0f,(float)(i))),(int)floor(height/pow(2.0f,(float)(i)))), IPL_DEPTH_32F, 1);
    
        imgU_array[i] = cvCreateImage(cvSize((int)floor(width/pow(2.0f,(float)(i))),(int)floor(height/pow(2.0f,(float)(i)))), IPL_DEPTH_32F, 1);
        imgV_array[i] = cvCreateImage(cvSize((int)floor(width/pow(2.0f,(float)(i))),(int)floor(height/pow(2.0f,(float)(i)))), IPL_DEPTH_32F, 1);
        imgU_res_err_array[i] = cvCreateImage(cvSize((int)floor(width/pow(2.0f,(float)(i))),(int)floor(height/pow(2.0f,(float)(i)))), IPL_DEPTH_32F, 1);
        imgV_res_err_array[i] = cvCreateImage(cvSize((int)floor(width/pow(2.0f,(float)(i))),(int)floor(height/pow(2.0f,(float)(i)))), IPL_DEPTH_32F, 1);
...
int VarFlow::CalcFlow(IplImage* imgA, IplImage* imgB, IplImage* imgU, IplImage* imgV, bool saved_data = false){
    ...
    while(1){
        ...
        gauss_seidel_recursive(k, (max_level - start_level), k, static_cast<float>(pow(2.0f,static_cast<float>(k))), imgAfxft_array, imgAfyft_array);
